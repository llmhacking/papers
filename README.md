...
| ag7 | Yang, S. et al. — [Hyperion: Unveiling DApp Inconsistencies using LLM and Dataflow-Guided Symbolic Execution](https://arxiv.org/abs/2408.06037) | ICSE | 2025 | 🤖⚙️📝 LLM+数据流符号执行检测DApp不一致性 |
| ag8 | — [GPTAid: LLM-Based Vulnerability Detection Using SAST](https://arxiv.org/abs/2409.09288) | NDSS | 2025 | 🤖⚙️ LLM+SAST辅助漏洞检测 |
...
| ag28 | 🎯 — [SIVA: Self-Improving Vulnerability Agent — Research Direction](https://openreview.net/pdf?id=JDN0x8eTPm) | OpenReview | 2025 | 🎯 TODO 🔄 自进化漏洞检测agent |
